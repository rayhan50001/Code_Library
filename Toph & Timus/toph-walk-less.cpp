...
int main()
{
    ...
    while(tt--)
    {
        ...
        while(!qu.empty())
        {
            ...
            {
                int next_node=gr[node][j].first;
                int Weight=gr[node][j].second;
                if(dis[node]+Weight<dis[next_node])
                {
                    dis[next_node]=dis[node]+Weight;
                    qu.push({next_node,dis[next_node]});
                }
            }
        }
        pf(dis[n]);
