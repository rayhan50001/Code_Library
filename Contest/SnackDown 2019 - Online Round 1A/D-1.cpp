...
int main()
{
    ...
    while(tt--)
    {
        ll a,b,c;
        sfll3(a,b,c);
        ll aBit=__builtin_popcount(a);
        ll bBit=__builtin_popcount(b);
        ll cBit=__builtin_popcount(c);
        cout<<aBit<<" "<<bBit<<" "<<cBit<<endl;
        if((aBit+bBit)==cBit && aBit==bBit)
        {
            ll total=aBit+bBit;
            total-=1;
        ...
        else if(aBit==cBit && aBit==bBit)
        {
            ll ans=(aBit*(aBit-1))/2;
            cout<<ans<<endl;
        }
        else if(bBit==cBit && aBit==bBit)
        {
            ll ans=(aBit*(aBit-1))/2;
            cout<<ans<<endl;
        }
